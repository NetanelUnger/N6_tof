/**
  ******************************************************************************
  * @file    stm32n6xx_nucleo_usbpd_pwr.c
...
/** @addtogroup STM32N6XX_USBPD_PWR
  * @{
  */

/** @defgroup STM32N6XX_NUCLEO_USBPD_PWR_Exported_Variables Exported Variables
  * @{
  */
/**
  * @}
...
/** @defgroup STM32N6XX_NUCLEO_USBPD_PWR_Private_Typedef Private Typedef
  * @{
  */
/**
...
/** @defgroup STM32N6XX_NUCLEO_USBPD_PWR_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32N6XX_NUCLEO_USBPD_PWR_Private_Macros Private Macros
  * @{
  */
#ifdef _TRACE
...
/** @defgroup STM32N6XX_NUCLEO_USBPD_PWR_Private_Functions Private Functions
  * @{
  */
...
/** @defgroup STM32N6XX_NUCLEO_USBPD_PWR_Private_Variables Private Variables
  * @{
  */
...
{
  {
    ...
    TCPP0203_I2C_ADDRESS_X68,                    /* TCPP0x on board (Address 0x34)              */
  },
};
...
/** @addtogroup STM32N6XX_NUCLEO_USBPD_PWR_Exported_Functions
  * @{
  */
...
int32_t BSP_USBPD_PWR_Init(uint32_t PortNum)
{
  ...
  Debug_UART_Log("USBPD", "TCPP0203 initialization started on port %lu",
    ...
    if (USBPD_PWR_Port_Status[PortNum].IsInitialized == 0U)
    {
      ...
      switch (USBPD_PWR_Port_Configs[PortNum].Type)
      {
        ...
        case USBPD_PWR_HW_CONFIG_TYPE_TCPP03:
          ...
          Debug_UART_Log("USBPD", "TCPP0203 I2C initialization result=%ld",
                         (long)ret);
          break;
      ...
      if (ret == BSP_ERROR_NONE)
      {
        ...
        Debug_UART_Log("USBPD", "TCPP0203 ready; CN8 power path is initialized");
      }
    }
  }
  return ret;
...
{
  static uint8_t ADC_Configured = USBPD_FALSE;
  int32_t ret;
...
/** @addtogroup STM32N6XX_NUCLEO_USBPD_PWR_Private_Functions
  * @{
  */
...
static void PWR_TCPP0203_Configure_ADC(void)
{
  ...
  (void) HAL_RCCEx_PeriphCLKConfig(&RCC_PeriphClkInitStructure);
...
static int32_t PWR_TCPP0203_BUSConfigInit(uint32_t PortNum, uint16_t Address)
{
  ...
  else
  {
    ...
    {
      Debug_UART_Log("USBPD", "TCPP component type=0x%02x", (unsigned int)tcpp_type);
