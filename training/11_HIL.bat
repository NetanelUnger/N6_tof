...
echo Radio feature flags are compared with the running image. Enabled BLE is
echo checked for NCP SDK version, GATT/advertising state and a real host scan;
