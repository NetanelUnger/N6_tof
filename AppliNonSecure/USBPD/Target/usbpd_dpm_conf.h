...
/*
 * The N6 Debug build uses considerably more stack in the TCPP0203 ADC/RCC
 * initialization path than the 1 KiB CubeMX middleware default.
 */
#define N6_USBPD_CAD_STACK_SIZE          (8U * 1024U)
