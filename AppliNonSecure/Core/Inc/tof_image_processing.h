...
typedef enum
{
    ...
    TOF_IMAGE_FILTER_OBJECT_1,
    TOF_IMAGE_FILTER_OBJECT_2,
    TOF_IMAGE_FILTER_OBJECT_3,
    TOF_IMAGE_FILTER_OBJECT_4,
    TOF_IMAGE_FILTER_OBJECT_5,
    TOF_IMAGE_FILTER_OBJECT_6,
    TOF_IMAGE_FILTER_OBJECT_7,
    TOF_IMAGE_FILTER_NPU,
