...
/* The CN8 TCPP0203 BSP uses ADC2 for VBUS sensing and I2C2 for control.  Keep
   these definitions in a CubeMX-preserved block so a later Generate Code does
   not silently remove the required HAL modules. */
