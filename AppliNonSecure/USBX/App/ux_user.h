...
/* Callback transmission mode is enabled.  The application submits one static
 * TX slot with ux_device_class_cdc_acm_write_with_callback() and does not
 * reuse it until the USBX completion callback fires. */
