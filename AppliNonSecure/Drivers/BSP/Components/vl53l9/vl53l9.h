...
/* Fully asynchronous steady-state frame pipeline.  Every function only
 * schedules one DMA transaction; completion is reported by the platform RX
 * or TX event.  The caller must keep p_buffer alive until completion. */
